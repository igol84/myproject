...
class Test_Item(TestItem):
    def test_01_initial(self):
        self.assertEqual(str(self.items[4].product.name), 'item23')
        self.assertEqual(str(self.items[4].qty), '3')
        self.assertEqual(str(self.items[4].buy_price.amount), '200.0')

    def test_02_edit(self):
        self.items[4].product = self.pc['3']
        self.assertEqual(str(self.items[4].product.name), 'item24')
        self.assertEqual(str(self.items[4].qty), '3')
        self.assertEqual(str(self.items[4].buy_price.amount), '200.0')
