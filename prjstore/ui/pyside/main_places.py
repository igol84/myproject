...
class PlacesEditor(QWidget, ObserverInterface):
    ...
    def __init__(self, parent: MainWindowInterface = None, test=False, user_data=None, list_pd_places=None, db=None,
                 dark_style=False):
        super().__init__()
        self.parent = parent
        self.__handler = None
        ...
        if parent:
            ...
            self.__connected_complete(PlacesEditorHandler(main_handler=self.parent.handler))
        else:
            if not test:
